...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        wishlist = tk.Label(title_frame,fg="white", bg="#a1dbcd") #creates label
   ...
   #     MovieBtn.pack(side = tk.LEFT)
        ...
        quit = tk.Button(bottom_frame, text="QUIT", fg="white",bd=0, bg="#af1700", width=10, height=2, command=self.master.destroy) #quit application button
        quit.pack(pady=30) #placement of button
